...
```
  ...
  We can see that with $K=1$ the model is flexible and we have by definition training hit rate _(red line)_ of $0$ but the *LOOCV* hit rate _(blue line)_ it’s higher, while with model lex flexible as with $k=98$ the two errors are similar. 
